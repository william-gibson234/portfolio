...
//Class controlling functionality of the Squat Rack equipment
public class SquatRack : Equipment
{
    public event EventHandler OnStartProgress;
    public event EventHandler OnStopProgress;

    public float barbellSpeed;

    [SerializeField] public PinpointBarUI pinpointBarUI;

    public Player player;

    public float playerPercentageCorrect;
    public float playerPercentageNecessary;

    public Vector3 barbellOriginalPosition;
    ...
    public virtual void PinpointBarUI_OnStoppedLifting(object sender, EventArgs e)
    {
        playerLiftingAnimator.Reset();
        if (playerPercentageCorrect > playerPercentageNecessary)
        {
            CallOnAnyLiftComplete(barbell.GetWeight(), "Squat", true, false);
        ...
        {
            CallOnAnyLiftComplete(barbell.GetWeight(), "Squat", false, false);
    ...
    public virtual void PinpointBarUI_OnBarProgressChanged(object sender, PinpointBarUI.OnBarProgressChangedEventArgs e)
    {
    ...
    public virtual void PinpointBarUI_OnProgressStopped(object sender, PinpointBarUI.OnProgressStoppedEventArgs e)
    {
    ...
    public void CallOnStartProgress()
    {
        OnStartProgress?.Invoke(this, EventArgs.Empty);
    }
    public void CallOnStopProgress()
    {
        OnStopProgress?.Invoke(this, EventArgs.Empty);
    }
}
